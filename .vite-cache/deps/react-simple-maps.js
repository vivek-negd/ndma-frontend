...
var dispatch_default4 = dispatch3;
...
var emptyOn = dispatch_default4("start", "end", "cancel", "interrupt");
var emptyTween = [];
var CREATED = 0;
var SCHEDULED = 1;
var STARTING = 2;
...
function tweenRemove(id2, name) {
  var tween0, tween1;
  return function() {
    var schedule = set5(this, id2), tween = schedule.tween;
    if (tween !== tween0) {
      tween1 = tween0 = tween;
...
function durationFunction(id2, value) {
  return function() {
    set5(this, id2).duration = +value.apply(this, arguments);
  };
}
function durationConstant(id2, value) {
  return value = +value, function() {
    set5(this, id2).duration = value;
  };
}
...
function onFunction(id2, name, listener) {
  var on0, on1, sit = start(name) ? init : set5;
  return function() {
...
function selectAll_default3(select) {
  ...
  for (var groups2 = this._groups, m = groups2.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children2 = select.call(node, node.__data__, i, group2), child, inherit2 = get4(node, id2), k = 0, l = children2.length; k < l; ++k) {
...
function styleMaybeRemove(id2, name) {
  ...
  return function() {
    var schedule = set5(this, id2), on = schedule.on, listener = schedule.value[key] == null ? remove2 || (remove2 = styleRemove2(name)) : void 0;
...
function end_default() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    that.each(function() {
      var schedule = set5(this, id2), on = schedule.on;
      if (on !== on0) {
        on1 = (on0 = on).copy();
